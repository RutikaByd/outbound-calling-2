...
DEFAULTS = {
    ...
    "TELEPHONY_PROVIDER":      os.getenv("TELEPHONY_PROVIDER", "vobiz"),
    ...
    "VOICELINK_SIP_USERNAME":      os.getenv("VOICELINK_SIP_USERNAME", ""),
    "VOICELINK_SIP_PASSWORD":      os.getenv("VOICELINK_SIP_PASSWORD", ""),
    "VOICELINK_OUTBOUND_NUMBER":   os.getenv("VOICELINK_OUTBOUND_NUMBER", ""),
    "VOICELINK_OUTBOUND_TRUNK_ID": os.getenv("VOICELINK_OUTBOUND_TRUNK_ID", ""),
...
SENSITIVE_KEYS = {
    ...
    "DEEPGRAM_API_KEY", "TWILIO_SIP_PASSWORD", "VOBIZ_PASSWORD",
...
async def get_all_settings() -> dict:
    ...
    KNOWN_KEYS = [
        ...
        "VOBIZ_OUTBOUND_NUMBER", "VOBIZ_OUTBOUND_TRUNK_ID",
        "VOICELINK_SIP_DOMAIN", "VOICELINK_SIP_USERNAME", "VOICELINK_SIP_PASSWORD",
        "VOICELINK_OUTBOUND_NUMBER", "VOICELINK_OUTBOUND_TRUNK_ID",
